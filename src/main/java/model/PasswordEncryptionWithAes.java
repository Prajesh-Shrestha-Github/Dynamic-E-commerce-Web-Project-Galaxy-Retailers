...
public class PasswordEncryptionWithAes {
    ...
    public static String decrypt1(String encryptedPassword, int userId) {
        try {
            byte[] decode = Base64.getDecoder().decode(encryptedPassword.getBytes(UTF_8));
            ...
            // get back the aes key from the same password and salt
            SecretKey aesKeyFromPassword = PasswordEncryptionWithAes.getAESKeyFromPassword(String.valueOf(userId).toCharArray(), salt);
